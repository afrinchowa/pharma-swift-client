...
import DeleteConfirmationModal from "@/components/ui/core/PSModel/DeleteConfirmationModal";
import { PSTable } from "@/components/ui/core/PSTable";
...
const ManageBrands = ({ brands }: { brands: IBrand[] }) => {
  ...
  return (
    <div>
      ...
      <PSTable columns={columns} data={brands || []} />
